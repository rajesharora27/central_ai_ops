...
AI_EVALUATION_GOVERNANCE_FILE="$ROOT/global/rules/global-ai-evaluation-governance.md"
MODEL_PROVIDER_GOVERNANCE_FILE="$ROOT/global/rules/global-model-and-provider-governance.md"
AI_OBSERVABILITY_FILE="$ROOT/global/rules/global-ai-observability.md"
RELEASE_ROLLOUT_GOVERNANCE_FILE="$ROOT/global/rules/global-release-and-rollout-governance.md"
BACKGROUND_JOBS_GOVERNANCE_FILE="$ROOT/global/rules/global-background-jobs-and-retries.md"
AI_SAFETY_GOVERNANCE_FILE="$ROOT/global/rules/global-ai-safety-governance.md"
OUTPUT_CONTRACTS_FILE="$ROOT/global/rules/global-output-contracts.md"
DATA_PROVENANCE_FILE="$ROOT/global/rules/global-data-provenance-and-rag.md"
MEMORY_CONTEXT_GOVERNANCE_FILE="$ROOT/global/rules/global-memory-and-context-governance.md"
PRIVACY_RETENTION_GOVERNANCE_FILE="$ROOT/global/rules/global-privacy-retention-and-deletion.md"
INCIDENT_RESPONSE_FILE="$ROOT/global/rules/global-incident-response.md"
PERFORMANCE_COST_FILE="$ROOT/global/rules/global-performance-and-cost-budgets.md"
ENVIRONMENT_PARITY_FILE="$ROOT/global/rules/global-environment-parity.md"
UX_RELIABILITY_FILE="$ROOT/global/rules/global-user-experience-reliability.md"
SCHEMA_MIGRATION_FILE="$ROOT/global/rules/global-schema-and-migration-governance.md"
...
require_file "$AI_EVALUATION_GOVERNANCE_FILE" "missing global AI evaluation governance doc"
require_file "$MODEL_PROVIDER_GOVERNANCE_FILE" "missing global model and provider governance doc"
require_file "$AI_OBSERVABILITY_FILE" "missing global AI observability doc"
require_file "$RELEASE_ROLLOUT_GOVERNANCE_FILE" "missing global release and rollout governance doc"
require_file "$BACKGROUND_JOBS_GOVERNANCE_FILE" "missing global background jobs and retries governance doc"
require_file "$AI_SAFETY_GOVERNANCE_FILE" "missing global AI safety governance doc"
require_file "$OUTPUT_CONTRACTS_FILE" "missing global output contracts doc"
require_file "$DATA_PROVENANCE_FILE" "missing global data provenance and RAG governance doc"
require_file "$MEMORY_CONTEXT_GOVERNANCE_FILE" "missing global memory and context governance doc"
require_file "$PRIVACY_RETENTION_GOVERNANCE_FILE" "missing global privacy retention and deletion governance doc"
require_file "$INCIDENT_RESPONSE_FILE" "missing global incident response doc"
require_file "$PERFORMANCE_COST_FILE" "missing global performance and cost budgets doc"
require_file "$ENVIRONMENT_PARITY_FILE" "missing global environment parity doc"
require_file "$UX_RELIABILITY_FILE" "missing global user experience reliability doc"
require_file "$SCHEMA_MIGRATION_FILE" "missing global schema and migration governance doc"
